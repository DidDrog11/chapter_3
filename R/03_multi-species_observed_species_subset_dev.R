...
# M0 Intercept model ---------------------------------------------------------
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_int.rds"))) {
  ...
  write_rds(out_ms_spatial_int, here("data", "observed_model_output", "model_dev", "spatial_int.rds"))
  gc()
  
} else {
  
  out_ms_spatial_int <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_int.rds"))
...
## M1 Landuse only ------------------------------------------------------------
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_1.rds"))) {
  ...
  write_rds(out_ms_spatial_1, here("data", "observed_model_output", "model_dev", "spatial_1.rds"))
  gc()
  
} else {
  
  out_ms_spatial_1 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_1.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_2.rds"))) {
  ...
  write_rds(out_ms_spatial_2, here("data", "observed_model_output", "model_dev", "spatial_2.rds"))
  gc()
} else {
  
  out_ms_spatial_2 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_2.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_3.rds"))) {
  ...
  write_rds(out_ms_spatial_3, here("data", "observed_model_output", "model_dev", "spatial_3.rds"))
  gc() 
} else {
  
  out_ms_spatial_3 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_3.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_4.rds"))) {
  ...
  write_rds(out_ms_spatial_4, here("data", "observed_model_output", "model_dev", "spatial_4.rds"))
  gc()
  
} else {
  
  out_ms_spatial_4 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_4.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_5.rds"))) {
  ...
  write_rds(out_ms_spatial_5, here("data", "observed_model_output", "model_dev", "spatial_5.rds"))
  gc()
  
} else {
  
  out_ms_spatial_5 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_5.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_6.rds"))) {
  ...
  write_rds(out_ms_spatial_6, here("data", "observed_model_output", "model_dev", "spatial_6.rds"))
  gc()
  
} else {
  
  out_ms_spatial_6 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_6.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_7.rds"))) {
  ...
  write_rds(out_ms_spatial_7, here("data", "observed_model_output", "model_dev", "spatial_7.rds"))
  gc()
  
} else {
  
  out_ms_spatial_7 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_7.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_8.rds"))) {
  ...
  write_rds(out_ms_spatial_8, here("data", "observed_model_output", "model_dev", "spatial_8.rds"))
  gc()
  
} else {
  
  out_ms_spatial_8 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_8.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_9.rds"))) {
  ...
  write_rds(out_ms_spatial_9, here("data", "observed_model_output", "model_dev", "spatial_9.rds"))
  gc()
  
} else {
  
  out_ms_spatial_9 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_9.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_10.rds"))) {
  ...
  write_rds(out_ms_spatial_10, here("data", "observed_model_output", "model_dev", "spatial_10.rds"))
  gc()
  
} else {
  
  out_ms_spatial_10 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_10.rds"))
...
if(!file.exists(here("data", "observed_model_output", "model_dev", "spatial_11.rds"))) {
  ...
  write_rds(out_ms_spatial_11, here("data", "observed_model_output", "model_dev", "spatial_11.rds"))
  gc()
  
} else {
  
  out_ms_spatial_11 <- read_rds(here("data", "observed_model_output", "model_dev", "spatial_11.rds"))
